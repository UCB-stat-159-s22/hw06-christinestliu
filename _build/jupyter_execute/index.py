...
if make_plots:
    ...
    plt.savefig('figurs/GW150914_strain.png')
...
if make_plots:
    ...
    plt.title('Advanced LIGO strain data near '+eventname)
    plt.savefig('figurs/GW150914_ASDs.png')
...
if make_plots:
    ...
    plt.savefig('figurs/GW150914_H1_spectrogram.png')
    ...
    plt.savefig('figurs/GW150914_L1_spectrogram.png')
...
if make_plots:
    ...
    plt.title('aLIGO H1 strain data near '+eventname)
    plt.savefig('figurs/GW150914_H1_spectrogram_whitened.png')
    ...
    plt.axis([-0.5, 0.5, 0, 500])
    plt.title('aLIGO L1 strain data near '+eventname)
    plt.savefig('figurs/GW150914_L1_spectrogram_whitened.png')
...
if make_plots:
    ...
    plt.savefig('figurs/GW150914_template.png')
...
for det in dets:
   ...
   if make_plots:
       ...
       plot_func(det, template_match, time, timemax, SNR, eventname, plottype, tevent, template_fft, datafreq, d_eff, freqs, data_psd, fs, pcolor, strain_whitenbp)
...
import os
os.remove('GW150914_H1_matchtime.png')
os.remove('GW150914_H1_SNR.png')
os.remove('GW150914_L1_matchtime.png')
os.remove('GW150914_L1_SNR.png')
...
# write the files:
write_wavfile("audio/GW150914_H1_whitenbp.wav",int(fs), strain_H1_whitenbp[indxd])
write_wavfile("audio/GW150914_L1_whitenbp.wav",int(fs), strain_L1_whitenbp[indxd])
...
write_wavfile("audio/GW150914_template_whiten.wav",int(fs), template_p_smooth[indxt])
...
fna = "audio/GW150914_template_whiten.wav"
print(fna)
Audio(fna)
...
fna = "audio/GW150914_H1_whitenbp.wav"
print(fna)
Audio(fna)
...
# write the files:
write_wavfile("audio/GW150914_H1_shifted.wav",int(fs), strain_H1_shifted[indxd])
write_wavfile("audio/GW150914_L1_shifted.wav",int(fs), strain_L1_shifted[indxd])

# and the template:
template_p_shifted = reqshift(template_p_smooth,fshift=fshift,sample_rate=fs)
write_wavfile("audio/GW150914_template_shifted.wav",int(fs), template_p_shifted[indxt])
...
fna = "audio/GW150914_template_shifted.wav"
print(fna)
Audio(fna)
...
fna = "audio/GW150914_H1_shifted.wav"
print(fna)
Audio(fna)
